...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data', default="/media/data4T2/meterdataset/digital_dataset/otherdataset/lmdb/train", help='path to training dataset')
    parser.add_argument('--valid_data', default="/media/data4T2/meterdataset/digital_dataset/otherdataset/lmdb/val", help='path to validation dataset')
