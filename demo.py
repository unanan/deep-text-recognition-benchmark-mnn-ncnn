...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_folder', default="/media/data4T2/meterdataset/digital_dataset/otherdataset/test", help='path to image_folder which contains text images')
    parser.add_argument('--workers', type=int, help='number of data loading workers', default=4)
    parser.add_argument('--batch_size', type=int, default=64, help='input batch size')
    parser.add_argument('--saved_model', default="/home/hs/projects/deep-text-recognition-benchmark/saved_models/finals/tps_w100xh70.pth", help="path to saved_model to evaluation")
    """ Data processing """
    parser.add_argument('--batch_max_length', type=int, default=10, help='maximum-label-length')
    parser.add_argument('--imgH', type=int, default=70, help='the height of the input image')
